...
1. Create or edit a course, and set **Course format** to **SmartCards** under Course settings.
2. Configure the format's own options (site-wide defaults, overridable per course):
   * **Navigation style** — Default, Accordion, Tabs, Sticky, Section cards, or Trail
...
4. To customise one activity's or section's own appearance, open its edit menu (kebab menu) and
   ...
   optional background colour, title colour, and title font.
5. Students see the resulting grid, with lock/timed/completion badges computed automatically —
   nothing further to configure per student.
