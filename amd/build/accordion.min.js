define("format_smartcards/accordion",["exports","core/ajax","theme_boost/bootstrap/collapse"],(function(_exports,_ajax,_collapse){var obj;
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_ajax=(obj=_ajax)&&obj.__esModule?obj:{default:obj};const SELECTORS_ACCORDION_BODY='[data-region="smartcards-accordion-body"]',handleToggle=(event,open)=>{event.target.matches(SELECTORS_ACCORDION_BODY)&&((sectionid,open)=>{_ajax.default.call([{methodname:"format_smartcards_toggle_section",args:{sectionid:Number(sectionid),open:open}}])[0]})(event.target.dataset.sectionid,open)};_exports.init=()=>{document.addEventListener("shown.bs.collapse",(event=>handleToggle(event,!0))),document.addEventListener("hidden.bs.collapse",(event=>handleToggle(event,!1)))}}));
